...
```{r q3a,echo=FALSE,fig.height=3, fig.width=6, fig.cap="\\textit{Left}: Scatter plot of the oxygen saturation data. \\textit{Right}: Boxplot of absolute values of differences in the measurements"}
#part a)
par(mfrow=c(1,2))
...
d) Code to compute (nonparametric) bootstrap estimates of bias and standard error
and a $95\%$ upper confidence bound for $\hat{\theta}$ computed using the percentile method. Results are presented in table 5.
